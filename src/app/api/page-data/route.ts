...
const brandList: brand[] = [
  {
    image: '/images/assets/thehindu___fetauredon.png',
    darkImg: '/images/assets/thehindu___fetauredon.png',
    title: 'The Hindu',
  },
  {
    image: '/images/assets/pragnews_fetauredon-removebg-preview.png',
    darkImg: '/images/assets/pragnews_fetauredon-removebg-preview.png',
    title: 'Prag News',
  },
  {
    image: '/images/assets/news18.png',
    darkImg: '/images/assets/news18.png',
    title: 'News18',
  },
  {
    image: '/images/assets/hornbill__fetauredon.png',
    darkImg: '/images/assets/hornbill__fetauredon.png',
    title: 'Hornbill',
  },
  {
    image: '/images/assets/thetimesofindia_fetauredon.png',
    darkImg: '/images/assets/thetimesofindia_fetauredon.png',
    title: 'Times of India',
  },
  {
    image: '/images/assets/ddnews.png',
    darkImg: '/images/assets/ddnews.png',
    title: 'DD News',
  },
]
...
const onlinePresenceList: onlinePresence[] = [
  {
    image: '/images/assets/goli_projects.png',
    title: 'Goli',
    tag: ['E-commerce Design', 'Brand Development'],
    link: 'https://www.wrappixel.com/',
  },
  {
    image: '/images/assets/lepoppy_projects.png',
    title: 'Lepoppy',
    tag: ['Web Development', 'UI/UX Design'],
    link: 'https://www.wrappixel.com/',
  },
  {
    image: '/images/assets/damatifoods-projects.png',
    title: 'Damati Foods',
    tag: ['Food Industry', 'Digital Marketing'],
    link: 'https://www.wrappixel.com/',
  },
  {
    image: '/images/assets/zubeenda_blog_ projects.png',
    title: 'Zubeenda Blog',
    tag: ['Content Platform', 'Blog Development'],
    link: 'https://www.wrappixel.com/',
  },
]
...
const faqList: faq[] = [
  {
    faq_que: 'What services does Webzyra offer?',
    faq_ans:
      'We offer comprehensive web development, UI/UX design, social media management, digital marketing, and brand development services to help businesses establish a strong online presence.',
  },
  {
    faq_que: 'How long does a typical project take?',
    faq_ans:
      'Project timelines vary based on complexity. Simple websites take 2-4 weeks, while complex web applications can take 8-12 weeks. We provide detailed timelines during our initial consultation.',
  },
  {
    faq_que: 'What is your pricing structure?',
    faq_ans:
      'We offer flexible pricing with our Starter plan at $2,500/month and Pro plan at $3,800/month. Custom projects are quoted based on scope, timeline, and specific requirements.',
  },
  {
    faq_que: 'Do you provide ongoing support after launch?',
    faq_ans:
  ...
  {
    faq_que: 'Can you redesign my existing website?',
    faq_ans:
      'Absolutely! We specialize in website redesigns to improve user experience, modernize design, enhance performance, and ensure mobile responsiveness while maintaining your brand identity.',
  },
  {
    faq_que: 'Do you work with small businesses or startups?',
    faq_ans:
      'Yes, we work with businesses of all sizes, from startups to established enterprises. Our flexible plans and scalable solutions are designed to grow with your business needs.',
  },
]
