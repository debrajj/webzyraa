        ...
        <div className='container'>
          <div className='gap-2'>
            <div className='flex justify-center text-center py-4 relative'>
              <p
                className='relative px-2 text-dark_black/60 dark:text-white/60 text-base md:text-lg
              ...
              <div className='py-1 Xsm:py-7'>
                ...
                <style jsx>{`
                  @media (min-width: 768px) {
                    .brand-slider-wrapper :global(.react-infinite-logo-slider) {
                      --slider-width: 300px;
                    }
                  }
                `}</style>
